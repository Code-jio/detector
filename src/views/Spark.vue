<template>
    ...
    <!-- <div class="spark-controls">
        ...
        <div class="control-group">\             
            <label>梭形大小: {{ sparkConfig.sparkSize }}</label>\             
            <input type="range" v-model="sparkConfig.sparkSize" min="0.01" max="0.5" step="0.01">\         
        </div>
         
         <div class="control-group">\             
            <label>火花概率: {{ sparkConfig.sparkProbability }}</label>\             
            <input type="range" v-model="sparkConfig.sparkProbability" min="0" max="1" step="0.05">
         </div>
